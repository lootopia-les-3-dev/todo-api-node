...
const options = {
  definition: {
    ...
    servers: [
      {
        url: process.env.API_URL || /* istanbul ignore next */ "http://localhost:3000",
        description: process.env.API_URL ? /* istanbul ignore next */ "Production" : /* istanbul ignore next */ "Local development",
      },
    ],
